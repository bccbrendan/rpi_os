...
impl Timer {
    ...
    pub fn read(&self) -> u64 {
        let usecs = (self.registers.CHI.read() as u64) << 32;
...
pub fn spin_sleep_us(us: u64) {
    // note, we don't handle overflow
    // becuase with a  64-but microsecond counter, 
    // we don't have to worry about overflow for 584,942 years
